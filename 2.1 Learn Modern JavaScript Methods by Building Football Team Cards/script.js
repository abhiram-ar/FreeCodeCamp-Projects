...
// We are going to use a method called Object.freeze(obj) which will freeze this object and 
  ...
  playerCards.innerHTML += arr
    .map(
      ({ name, position, number, isCaptain, nickname }) =>
        ...
        //  In order to access each of those properties inside the callback function,   
        //  you will need to use object destructuring to unpack them into variables.
        `
    ...
    // To remove the commas between each player-card so it does not show up on screen, 
    // chain the .join() method to the .map() method. Pass an empty string as the argument for the .join() method.
};
